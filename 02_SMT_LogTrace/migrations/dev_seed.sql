...
INSERT INTO parser_profile (device_id, file_type, profile_name, enabled) VALUES
    ...
    ('FCT-TRI-01', 'RUNTIME_LOG', 'kv_runtime_v1', 1),
    ('FCT-TRI-02', 'RUNTIME_LOG', 'kv_runtime_v1', 1),
    ('FCT-TRI-03', 'RUNTIME_LOG', 'kv_runtime_v1', 1),
    ('FCT-TRI-01', 'TEST_REPORT', 'fct_csv_v1', 1),
    ('FCT-TRI-02', 'TEST_REPORT', 'fct_csv_v1', 1),
    ('FCT-TRI-03', 'TEST_REPORT', 'fct_csv_v1', 1)
AS new
